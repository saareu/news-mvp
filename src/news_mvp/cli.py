...
def etl_run(
    ...
    # Lookup optional force_tz_offset for this source from settings
    try:
        force_tz = s.etl.sources[source].force_tz_offset
    except Exception:
        force_tz = None

    run_etl_for_source(source=source, rss_url=rss_url, force_tz_offset=force_tz)
