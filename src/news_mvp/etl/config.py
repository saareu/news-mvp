...
MASTER_HAARETZ_JSON = Path(
    _get("MASTER_HAARETZ_JSON", MASTER_DIR / "master_haaretz.json")
)
...
HAYOM_CANON_JSON = Path(
    _get("HAYOM_CANON_JSON", CANON_HAYOM_DIR / "hayom_canonical.json")
)

HAARETZ_ITEMS_JSON = Path(
    _get("HAARETZ_ITEMS_JSON", RAW_HAARETZ_DIR / "haaretz_items.json")
)
HAARETZ_ITEMS_CSV = Path(
    _get("HAARETZ_ITEMS_CSV", RAW_HAARETZ_DIR / "haaretz_items.csv")
)
HAARETZ_CANON_CSV = Path(
    _get("HAARETZ_CANON_CSV", CANON_HAARETZ_DIR / "haaretz_canonical.csv")
)
HAARETZ_CANON_JSON = Path(
    _get("HAARETZ_CANON_JSON", CANON_HAARETZ_DIR / "haaretz_canonical.json")
)
